...
public class PersonApiController {
   ...
   public ResponseEntity<Object> postPerson(@RequestBody PersonDto personDto) {
       ...
       // Assign ROLE_STUDENT to every new registration
       PersonRole studentRole = personDetailsService.findRole("ROLE_STUDENT");
       if (studentRole == null) {
           studentRole = personDetailsService.findRole("STUDENT");
       }
       if (studentRole != null && !person.hasRoleWithName(studentRole.getName())) {
           person.getRoles().add(studentRole);
       }
